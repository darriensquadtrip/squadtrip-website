const features = [
  {
    ...
    description:
      "Set up monthly auto-billing so travelers pay on schedule. No more chasing payments or awkward reminders.",
    icon: "credit-card",
  },
  {
    title: "Real-Time Dashboard",
    description:
      "Track who's paid, who hasn't, and total revenue at a glance. Export data anytime for your records.",
    icon: "chart",
  },
  {
    title: "Shareable Booking Pages",
    description:
      "Create beautiful trip pages with itinerary, packages, and add-ons. Share a single link for bookings.",
    icon: "link",
  },
  {
    title: "Automated Reminders",
    description:
      "Send email and SMS reminders for upcoming payments. Set them once, and they go out automatically.",
    icon: "bell",
  },
  {
    title: "Flexible Pricing",
    description:
      "Offer deposits, full payment, or installment plans. Pass fees to travelers or absorb them yourself.",
    icon: "dollar",
  },
  {
    title: "Registration & Waivers",
    description:
      "Collect traveler info, passport details, dietary preferences, and e-signatures all at checkout.",
    icon: "clipboard",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
            Everything you need to manage group trips
          </h2>
